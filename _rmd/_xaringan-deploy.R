...
rmarkdown::render(input = "_rmd/xaringan.Rmd",
                  output_format = 'xaringan::moon_reader',
                  output_file = "xaringan-prez.html",
                  output_dir = "static/xaringan-prez/",
                  clean = TRUE)
browseURL("static/xaringan-prez/xaringan-prez.html")
...
pagedown::chrome_print("http://127.0.0.1:4000/static/xaringan-prez/xaringan-prez.html",
                       output = "~/projects/jekyll/zgfabian.github.io/static/xaringan-prez/xaringan-prez/xaringan-prez.pdf")
